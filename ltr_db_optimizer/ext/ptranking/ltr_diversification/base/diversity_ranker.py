...
from ltr_db_optimizer.ext.ptranking.ltr_diversification.base.div_list_ranker import DivListNeuralRanker
from ltr_db_optimizer.ext.ptranking.ltr_diversification.base.div_point_ranker import DivPointNeuralRanker
